...
public class TitleManager : MonoBehaviour
{
    ...
    // 비동기 작업을 통해서 게임을 멈추지 않고 백그라운에서 다음 씬(로비 씬)의 게임 오브젝트들을 "미리" 불러올 수 있음.
    private IEnumerator LoadGameCo()
    {
        ...
        */
        ...
        // 로고 애니메이션 재생
        LogoAnim.Play();
        yield return new WaitForSeconds(LogoAnim.clip.length); // 로고 애니메이션 길이만큼 대기
        ...
        */
        ...
        while (!m_AsyncOperation.isDone) //로딩이 진행 중일 때 
        {
            ...
            {
                m_AsyncOperation.allowSceneActivation = true; // 씬 전환 허용.
                yield break;
            }
